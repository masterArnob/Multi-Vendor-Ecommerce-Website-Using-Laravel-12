...
<head>
    ...
    @if (@$settings->layout === 'RTL')
           <link href="{{ asset('vendo/dist/css/tabler.rtl.min.css?1692870487') }}" rel="stylesheet"/>
    <link href="{{ asset('vendo/dist/css/tabler-flags.rtl.min.css?1692870487') }}" rel="stylesheet"/>
    <link href="{{ asset('vendo/dist/css/tabler-payments.rtl.min.css?1692870487') }}" rel="stylesheet"/>
    <link href="{{ asset('vendo/dist/css/tabler-vendors.rtl.min.css?1692870487') }}" rel="stylesheet"/>
    <link href="{{ asset('vendo/dist/css/demo.rtl.min.css?1692870487') }}" rel="stylesheet"/>
        <style>
...
<body>
    ...
    <script src="{{ asset('vendo/dist/libs/jsvectormap/dist/js/jsvectormap.min.js?1692870487') }}" defer></script>
