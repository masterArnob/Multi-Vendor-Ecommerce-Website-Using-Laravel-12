                    ...
                    <form action="{{ route('admin.withdraw-method.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="col-md-7">
                                ...
                                <input type="text" name="maximum_amount" value="{{ old('maximum_amount') }}" class="form-control">
                              ...
                              <div class="col-md-7">
                                ...
                                <input type="text" name="withdraw_charge" value="{{ old('withdraw_charge') }}" class="form-control">
