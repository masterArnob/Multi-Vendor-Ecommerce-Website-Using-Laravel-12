                        ...
                        <div class="row g-3 align-items-center">
                              ...
                              <div class="col-md-7">
                                ...
                                <select name="category_id" class="form-select">
                                    @forelse ($cats as $cat)
                                       <option @selected($cat->id == $subcat->category_id) value="{{ $cat->id }}">{{ $cat->name }}</option>
                                    @empty
                                        No Data Available
                                    @endforelse
                            ...
                            <div class="col-md-7">
                                ...
                                <select name="status" class="form-select">
                                    <option @selected($subcat->status === 1) value="1">Active</option>
                                    <option @selected($subcat->status === 0) value="0">Inactive</option>
                                </select>
                            </div>
                        </div>
