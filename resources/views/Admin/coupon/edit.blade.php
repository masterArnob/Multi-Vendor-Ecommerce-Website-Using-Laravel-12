                        ...
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="col-md-7">
                               ...
                               <div class="col-md-7">
                                ...
                                <input type="text" name="quantity" value="{{ old('quantity', $coupon->quantity) }}" class="form-control">
                            ...
                            <div class="col-md-7">
                                ...
                                <input type="text" name="max_use" value="{{ old('max_use', $coupon->max_use) }}" class="form-control">
                              ...
                              <div class="col-md-7">
                                <div class="form-label">Start Date</div>
                                     <input name="start_date" class="form-control datepicker"
                                                value="{{ old('start_date', $coupon->start_date) }}" id="offer-start-datepicker">
                                ...
                                <input name="end_date" class="form-control datepicker"
                                                value="{{ old('end_date', $coupon->end_date) }}" id="offer-end-datepicker">
