            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.single-category.update', 1) }}" method="POST"
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="cat_one" class="form-select category">
                                                ...
                                                @forelse ($categories as $category)
                                                    <option @selected($category->id == @$singleCat[0]->category)
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="sub_cat_one" class="form-select sub-category">
                                                ...
                                                @forelse ($subCats as $subCat)
                                                    <option @selected($subCat->id == $singleCat[0]->sub_category)
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="child_cat_one" class="form-select child-category">
                                                ...
                                                @forelse ($childCats as $childCat)
                                                    <option @selected($childCat->id == @$singleCat[0]->child_category)
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="cat_one" class="form-select category">
                                                <option value="">Select</option>
                                                @forelse ($categories as $category)
                                                    <option @selected($category->id == @$singleCat2[0]->category)
                                                        value="{{ $category->id }}">{{ $category->name }}</option>
                                                @empty
                                                    No Data Available
                                                @endforelse
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="sub_cat_one" class="form-select sub-category">
                                                <option value="">Select</option>
                                                @forelse ($subCats as $subCat)
                                                    <option @selected($subCat->id == $singleCat2[0]->sub_category)
                                                        value="{{ $subCat->id }}">{{ $subCat->name }}</option>
                                                @empty
                                                    No Data Available
                                                @endforelse
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="child_cat_one" class="form-select child-category">
                                                <option value="">Select</option>
                                                @forelse ($childCats as $childCat)
                                                    <option @selected($childCat->id == @$singleCat2[0]->child_category)
                                                        value="{{ $childCat->id }}">{{ $childCat->name }}</option>
                                                @empty
                                                    No Data Available
                                                @endforelse
    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h2 class="mb-4">Single Category Section Three</h2>
                        ...
                        <form action="{{ route('admin.single-category.update', 1) }}" method="POST"
                            ...
                            <input type="hidden" name="single_cat_value" value="3">
                            ...
                            <div class="row g-3 align-items-center">
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        @php
                                            @$singleCat3 = json_decode($singleCatThree->value);
                                            //dd($singleCat);
                                        @endphp
                                        <div class="col-md-4">
                                            <div class="form-label">Category</div>
                                            <select name="cat_one" class="form-select category">
                                                <option value="">Select</option>
                                                @forelse ($categories as $category)
                                                    <option @selected($category->id == @$singleCat3[0]->category)
                                                        value="{{ $category->id }}">{{ $category->name }}</option>
                                                @empty
                                                    No Data Available
                                                @endforelse
                                        ...
                                        <div class="col-md-4">
                                            @php
                                                $subCats = App\Models\SubCategory::where('category_id', @$singleCat3[0]->category)
                                                    ->where('status', 1)
                                                    ->get();
                                            @endphp
                                            <div class="form-label">Sub Category</div>
                                            <select name="sub_cat_one" class="form-select sub-category">
                                                <option value="">Select</option>
                                                @forelse ($subCats as $subCat)
                                                    <option @selected($subCat->id == $singleCat3[0]->sub_category)
                                                        value="{{ $subCat->id }}">{{ $subCat->name }}</option>
                                                @empty
                                                    No Data Available
                                                @endforelse
                                        ...
                                        <div class="col-md-4">
                                            @php
                                                $childCats = App\Models\ChildCategory::where('sub_category_id', @$singleCat3[0]->sub_category)
                                                    ->where('status', 1)
                                                    ->get();
                                            @endphp
                                            <div class="form-label">Child Category</div>
                                            <select name="child_cat_one" class="form-select child-category">
                                                <option value="">Select</option>
                                                @forelse ($childCats as $childCat)
                                                    <option @selected($childCat->id == @$singleCat3[0]->child_category)
                                                        value="{{ $childCat->id }}">{{ $childCat->name }}</option>
                                                @empty
                                                    No Data Available
                                                @endforelse
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="cat_two" class="form-select category">
                                                <option value="">Select</option>
                                                @forelse ($categories as $category)
                                                    <option @selected($category->id == @$singleCat3[1]->category)
                                                        value="{{ $category->id }}">{{ $category->name }}</option>
                                                @empty
                                                    No Data Available
                                                @endforelse
                                        ...
                                        <div class="col-md-4">
                                            @php
                                                $subCats = App\Models\SubCategory::where('category_id', @$singleCat3[1]->category)
                                                    ->where('status', 1)
                                                    ->get();
                                            @endphp
                                            <div class="form-label">Sub Category</div>
                                            <select name="sub_cat_two" class="form-select sub-category">
                                                <option value="">Select</option>
                                                @forelse ($subCats as $subCat)
                                                    <option @selected($subCat->id == $singleCat3[1]->sub_category)
                                                        value="{{ $subCat->id }}">{{ $subCat->name }}</option>
                                                @empty
                                                    No Data Available
                                                @endforelse
                                        ...
                                        <div class="col-md-4">
                                            @php
                                                $childCats = App\Models\ChildCategory::where('sub_category_id', @$singleCat3[1]->sub_category)
                                                    ->where('status', 1)
                                                    ->get();
                                            @endphp
                                            <div class="form-label">Child Category</div>
                                            <select name="child_cat_two" class="form-select child-category">
                                                <option value="">Select</option>
                                                @forelse ($childCats as $childCat)
                                                    <option @selected($childCat->id == @$singleCat3[1]->child_category)
                                                        value="{{ $childCat->id }}">{{ $childCat->name }}</option>
                                                @empty
                                                    No Data Available
                                                @endforelse
