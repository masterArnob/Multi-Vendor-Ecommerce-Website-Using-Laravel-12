    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h2 class="mb-4">Edit Vendor Product</h2>

                        <form action="{{ route('admin.vendor-product.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row g-3 align-items-center">
                                <div class="col-md-7">
                                    ...
                                    <input type="text" name="name" value="{{ $vendor->name }}" disabled class="form-control">
                                    ...
                                    <div class="form-label">Product Thumb Image</div>
                                    <div class="col-auto">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select name="sub_category_id" class="form-select sub-category">
                                                ...
                                                @forelse ($subCategories as $subCat)
                                                    <option @selected($subCat->id === $product->sub_category_id) value="{{ $subCat->id }}">{{ $subCat->name }}</option>
                                                @empty
                                                    No Data Available
                                                @endforelse
                                            </select>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select name="child_category_id" class="form-select child-category">
                                                ...
                                                @forelse ($childCategories as $childCategory)
                                                       <option @selected($childCategory->id === $product->child_category_id) value="{{ $childCategory->id }}">{{ $childCategory->name }}</option>
                                                @empty
                                                    No Data Available
                                                @endforelse
                                ...
                                <div class="col-md-7">
                                    ...
                                    <input type="text" name="offer_price" value="{{ old('offer_price', $product->offer_price) }}"
                                        class="form-control">
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            ...
                                            <input name="offer_start_date" class="form-control datepicker"
                                                value="{{ old('offer_start_date', $product->offer_start_date) }}" id="offer-start-datepicker">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input name="offer_end_date" class="form-control datepicker"
                                                value="{{ old('offer_end_date', $product->offer_end_date) }}" id="offer-end-datepicker">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <textarea name="seo_description" class="form-control summernote">{{ old('seo_description', $product->seo_description) }}</textarea>
                                 ...
                                 <div class="col-md-7">
                                    <div class="form-label">Is Approved</div>
                                  <select name="is_approved" class="form-control">
                                    <option @selected($product->is_approved === 1) value="1">Approved</option>
                                    <option @selected($product->is_approved === 0) value="0">Pending</option>
                                  </select>
                                </div>
