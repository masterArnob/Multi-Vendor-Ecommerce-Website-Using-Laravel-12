                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4">
                        <div class="wsus__pay_booking_summary" id="sticky_sidebar2">
                            ...
                            <p>discount: <span class="text-danger">(-){{ $settings->currency_icon }}{{ discount() }}</span></p>
                            <p>shipping fee: <span class="text-success">(+){{ $settings->currency_icon }}{{ shippingFee() }} </span></p>
