                                            ...
                                            <div class="col-xl-6 col-xxl-7 col-md-6 mt-4 mt-md-0">
                                                <div class="wsus__pro_det_vendor_text">
                                                    <h4>
                                                     ...
                                                     @if ($product->vendor_id === 0)
                                                            <img src="{{ asset($product->admin->image) }}" alt="vensor" style="width: 100px !important; height: auto;">>
                                                        @else
                                                          <img src="{{ asset($product->vendor->image) }}" alt="vendor" style="width: 100px !important; height: auto;">
                                                        @endif
