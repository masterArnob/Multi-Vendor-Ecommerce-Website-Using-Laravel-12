...
class VendorReviewsDataTable extends DataTable
{
    /**
     * Build the DataTable class.
     *
     * @param QueryBuilder<VendorReview> $query Results from query() method.
     */
     ...
     *
     * @return QueryBuilder<VendorReview>
     */
    ...
    {
        return $this->builder()
                    ->setTableId('vendorreviews-table')
    ...
    {
        return 'VendorReviews_' . date('YmdHis');
    }
}
