...
class AdminAllOrdersDataTable extends DataTable
{
    /**
     * Build the DataTable class.
     *
     * @param QueryBuilder<AdminAllOrder> $query Results from query() method.
     */
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
             ->addColumn('action', function ($query) {
  $view = '<a href="' . route('admin.all-orders.show', $query->id) . '" class="btn btn-info">
...
$delete = '<a href="' . route('admin.all-orders.destroy', $query->id) . '" class="btn btn-danger delete-item">
     ...
     *
     * @return QueryBuilder<AdminAllOrder>
     */
    ...
    {
        return $this->builder()
                    ->setTableId('adminallorders-table')
    ...
    {
        return 'AdminAllOrders_' . date('YmdHis');
    }
}
