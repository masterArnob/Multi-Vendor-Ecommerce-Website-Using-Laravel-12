...
class ChildCategoryDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
                ...
                $edit = '<a href="' . route('admin.child-category.edit', $query->id) . '" class="btn btn-warning mx-2">
                        Edit
                      </a>';
                $delete = '<a href="' . route('admin.child-category.destroy', $query->id) . '" class="btn btn-danger delete-item">
                        Delete
                      </a>';
